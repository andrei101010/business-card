...
let profileState = {
  ...
  avatar: {
    enabled: "block",
    url: "<?php echo base_url(); ?>" + "/assets/images/face1.jpg"
  },
  contacts: {
    enabled: "block",
    info: [{
...
const settingState = {
  ...
  fontStyle:"Work Sans",
  fontName: "Work Sans",
  pageLoader:"<?php echo base_url(); ?>" + "/assets/images/windows.png"
}
...
const imageState = {
  ...
  photos: [{
      state: true,
      url: "<?php echo base_url(); ?>" + "/assets/images/img4.webp"
    },
    {
      state: true,
      url: "<?php echo base_url(); ?>" + "/assets/images/img5.webp"
    }
  ],
  cardBack: "block"
};
...
const contactUsState = {
  enabled: "block",
  title: "Contact Us",
  images: "<?php echo base_url(); ?>" + "/assets/images/smartPhone.png",
  floatingButton: {
    enabled: "block",
    text: "Add to Contact"
  },
...
const LinkItem = {
  enabled: 'block',
  link: "",
  image: "<?php echo base_url(); ?>" + "/assets/images/link.png",
  title: "Portfolio",
  subtitle: {
    enabled: "block",
...
let pdfState = {
  enabled:'block',
  header:{enabled:'block', title:'Other Information', description:''},  
  pdfItems:[{url:'', pdfAvatar:'<?php echo base_url(); ?>' + '/assets/images/pdf.png', title:'PDF 1', description:'PDF Description', subTitleEnabled:'block'},{url:'', pdfAvatar:'<?php echo base_url(); ?>' + '/assets/images/pdf.png', title:'PDF 1', description:'PDF Description', subTitleEnabled:'block'}],
  cardEnabled:'block'
};
