                  ...
                  <div class="fixedHeightListContainerInner">
                    <ul class="popup_gntr_pic_list">
                      <li class="js_qr_action_item" data-type="qrshape" track_state="1" group-type="" data-index="0">
                        ...
                        <img src="./assets/images/qr_code_square.png" loading="lazy" data-type="li-img" onclick="qrShapeClick()" style="background-size: contain">
                      </li>
                      <li class="js_qr_action_item active" data-type="qrshape" track_state="1" group-type="" data-index="1">
                        <div class="close_pic js_close_pic" onclick="qrShapeCancel()" id="idfig1"><i class="icon-cross" onclick="qrShapeCancel()"></i></div><img src="./assets/images/qr_code_circle.png" loading="lazy" data-type="li-img" onclick="qrShapeClick()" style="background-size: contain">
                      </li>
                    </ul>
                  </div>
