        ...
        <div class="row">
          <div class="col-md-3">
            <div class="qr_design_card_wrapper selected" onclick="showDesignPopUp('#gntr_qrshapes_tab-1'); return false;">
              ...
              <div class="d-flex justify-content-center align-items-center qr_design_card">
                <a class="w-100"><img src="./assets/images/qr_code_square.png" class="img-fluid"></a>
              </div>
            </div>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="qr_design_card_wrapper " onclick="showDesignPopUp('#gntr_bgimg_tab-1'); return false;">
              ...
              <div class="d-flex justify-content-center align-items-center qr_design_card"><a class="w-100"><img src="./assets/images/upload_qr.png" class="img-fluid"></a></div>
            </div>
          </div>
        </div>
      </div>
...
<div class="tab-pane fade none" id="page-tab-bulk-upload-content" role="tabpanel"
  ...
  <div class="">
    <div class="p-2">
      <img src="/assets/images/how_it_works_bulkupload.png" class="img-fluid" alt="How bulk upload works?" data-xblocker="processing" style="visibility: hidden;">
    </div>
    <div class="py-4">
      <div class="row">
